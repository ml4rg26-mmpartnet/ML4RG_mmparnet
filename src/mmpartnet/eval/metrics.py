"""Metrics — dependency-light (no sklearn), shared by every experiment + a teammate's model.
...
# average_precision already lives in the experiments layer (single source of truth); re-export it.
from mmpartnet.experiments.binding_eval import average_precision  # noqa: F401

...
def _install_stubs():
    ...
    import parnet.layers as _pl                       # NewAdditiveMix alias for the full-rbp-set checkpoint
    if not hasattr(_pl, "NewAdditiveMix") and hasattr(_pl, "AdditiveMix"):
        _pl.NewAdditiveMix = _pl.AdditiveMix
    _LOADED = True

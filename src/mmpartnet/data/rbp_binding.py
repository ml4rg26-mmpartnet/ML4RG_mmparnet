...
BASE = Path("/mnt/storage1")

_DATA_PT = (
    BASE
    / "ml4rg26-mmparnet/manually_gathered/"
    "600nt_windows.no-one-hot.stripped.binding/"
    "600nt_windows.no-one-hot.stripped.binding.narrowpeak_intersect/"
    "dataset.pt"
)
_RBP_TSV = BASE / "ml4rg26-shared/parnet-eclip/models-full-rbp-set/full_rbp_set.tsv"
_FASTA   = BASE / "ml4rg26-mmparnet/manually_gathered/ProtT5_zenodo_datasets/human.fasta"
_EMB_H5  = BASE / "ml4rg26-mmparnet/manually_gathered/ProtT5_zenodo_datasets/reduced_embeddings_file.h5"

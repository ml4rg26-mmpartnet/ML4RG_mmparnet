#!/usr/bin/env python
"""Evaluate a trained protein+cell FiLM multitask checkpoint.

This script is intentionally separate from training. It lets us re-score the
same checkpoint on valid/test with different evaluation ranges or metrics

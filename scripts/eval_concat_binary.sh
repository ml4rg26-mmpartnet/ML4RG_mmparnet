#!/usr/bin/env bash
# Evaluate the trained concat binary-only checkpoint on the validation split.
# Paired with scripts/eval_film_binary.sh — identical flags except --arch and --checkpoint path.
...
RUN_DIR=/mnt/storage1/ml4rg26-mmparnet/ML4RG_mmparnet/results/film_multitask/compare_concat_binary_seed0
